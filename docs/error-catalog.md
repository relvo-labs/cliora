...
| Code | HTTP | Message | Cause | Next step | Retryable | Audited | Origin |
|---|---:|---|---|---|:--:|:--:|:--:|
| `RUNTIME_NOT_ALLOWED` | 400 | Runtime is not allowed | The requested runtime is not in the closed allowlist (claude, codex). | Choose an allowlisted runtime. | no | no | daemon |
