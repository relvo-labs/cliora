...
def _load_xml_dependency() -> None:
    global defusedxml
    if defusedxml is None:
        try:
            defusedxml = importlib.import_module("defusedxml")
            importlib.import_module("defusedxml.minidom")
        except ModuleNotFoundError as exc:
            raise RuntimeError("comment.py requires the defusedxml package") from exc
