...
> **2026-08-12 加開 V2.2_1。** 它不推進任何新功能，所以不算第六個階段——
> 它把 V2.0–V2.2 已宣稱交付的前端補到可用：那三期的前端引用了 **104 個從未定義的
> CSS custom property**，瀏覽器整條丟棄那些宣告，看板／任務詳情／藍圖因此
> **以接近無樣式的 HTML 在渲染**。詳見 [`12-phase-v22_1-ui-remediation.md`](./12-phase-v22_1-ui-remediation.md)。
